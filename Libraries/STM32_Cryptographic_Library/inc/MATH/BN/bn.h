...
/* Alloc big *****************************************************************/
int32_t StAllocBig(BigNum_stt **P_ppBignum, int32_t P_wordSize, membuf_stt *P_pMembuf);

/* StFree big ****************************************************************/
void StFreeBig(BigNum_stt **P_pBignum, membuf_stt *P_pMembuf);

/* x = initial_value. Sets the words x->pmDigit[1]_ _ _x->pmDigit[MAX_LEN_BIG-1] to 0. */
void InitBig(BigNum_stt * P_pBN, int32_t P_initialValue);

/* y=x. ***********************************************************************/
int32_t CopyBig(const BigNum_stt *P_pInputBN, BigNum_stt *P_pOutputBN);
...
int32_t CompareBig(const BigNum_stt *P_pInput1BN, const BigNum_stt *P_pInput2BN);
...
uint16_t GiveBit(const BigNum_stt *P_pBN, uint32_t P_pos);
