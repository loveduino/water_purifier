...
void W32_to_W8(const uint32_t *P_pArrayIn, uint8_t *P_pArrayOut, int32_t P_ReqW8);

/* Converts a vector of 8 bits words ("in") to a BigNum_stt * ("out"). ********/  
int32_t W8_to_Big(const uint8_t *P_pArrayIn, uint32_t P_ArrayInSize, BigNum_stt * P_outBig);

/* Converts a BigNum_stt * ("in") to a vector of 8 bits words ("out").*********/  
void Big_to_W8(BigNum_stt * P_inBig, uint8_t *P_pArrayOut, int32_t *P_pArrayOutSize);

/* Converts a BigNum_stt * ("in") to a vector of 8 bits words of fixed size("out") */  
int32_t Big_to_fixedW8(BigNum_stt * P_pInBig, uint8_t *P_pArrayOut, int32_t P_pArrayOutSize);
/**
  * @}
  */
