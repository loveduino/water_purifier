...
/**
  ...
  */
int32_t Ymodem_Receive (uint8_t *buf, uint32_t application_address)
{
...
/**
  ...
  * @retval The size of the file
  */
uint8_t Ymodem_Transmit (uint8_t *buf, const uint8_t* sendFileName, uint32_t sizeFile, uint32_t application_address)
{
